...
class Table(Component):
    ...
    def __init__(
        ...
        optionalNumber: typing.Optional[
        ...
        optionalUnion: typing.Optional[
            typing.Union[str, typing.Union[int, float, numbers.Number], typing.Any]
        ] = None,
        optionalArrayOf: typing.Optional[
            typing.Sequence[typing.Union[int, float, numbers.Number]]
        ] = None,
        optionalObjectOf: typing.Optional[
            typing.Dict[
                typing.Union[str, float, int], typing.Union[int, float, numbers.Number]
            ]
        ] = None,
